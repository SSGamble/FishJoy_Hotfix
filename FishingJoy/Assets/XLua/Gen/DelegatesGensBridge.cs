...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp3(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp16(object p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public Gun __Gen_Delegate_Imp19()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp3);
			}
